...
func (OAuthClientAuth_PrivateKeyJwt_CertificateHeader) EnumDescriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{66, 0, 1}
}
...
type BackendPolicySpec struct {
	...
	//	*BackendPolicySpec_LoadBalancing_
...
func (x *BackendPolicySpec) GetLoadBalancing() *BackendPolicySpec_LoadBalancing {
	if x != nil {
		if x, ok := x.Kind.(*BackendPolicySpec_LoadBalancing_); ok {
...
type BackendPolicySpec_LoadBalancing_ struct {
	LoadBalancing *BackendPolicySpec_LoadBalancing `protobuf:"bytes,19,opt,name=load_balancing,json=loadBalancing,proto3,oneof"`
}
...
func (*BackendPolicySpec_LoadBalancing_) isBackendPolicySpec_Kind() {}
...
type BackendPolicySpec_LoadBalancing struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The load balancing algorithm.
	//
	// Types that are valid to be assigned to Algorithm:
	//
	//	*BackendPolicySpec_LoadBalancing_ConsistentHash_
	Algorithm     isBackendPolicySpec_LoadBalancing_Algorithm `protobuf_oneof:"algorithm"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *BackendPolicySpec_LoadBalancing) Reset() {
	*x = BackendPolicySpec_LoadBalancing{}
	mi := &file_resource_proto_msgTypes[149]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BackendPolicySpec_LoadBalancing) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BackendPolicySpec_LoadBalancing) ProtoMessage() {}

func (x *BackendPolicySpec_LoadBalancing) ProtoReflect() protoreflect.Message {
	mi := &file_resource_proto_msgTypes[149]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BackendPolicySpec_LoadBalancing.ProtoReflect.Descriptor instead.
func (*BackendPolicySpec_LoadBalancing) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{56, 12}
}

func (x *BackendPolicySpec_LoadBalancing) GetAlgorithm() isBackendPolicySpec_LoadBalancing_Algorithm {
	if x != nil {
		return x.Algorithm
	}
	return nil
...
func (x *BackendPolicySpec_LoadBalancing) GetConsistentHash() *BackendPolicySpec_LoadBalancing_ConsistentHash {
	if x != nil {
		if x, ok := x.Algorithm.(*BackendPolicySpec_LoadBalancing_ConsistentHash_); ok {
...
type isBackendPolicySpec_LoadBalancing_Algorithm interface {
	isBackendPolicySpec_LoadBalancing_Algorithm()
}

type BackendPolicySpec_LoadBalancing_ConsistentHash_ struct {
	ConsistentHash *BackendPolicySpec_LoadBalancing_ConsistentHash `protobuf:"bytes,1,opt,name=consistent_hash,json=consistentHash,proto3,oneof"`
}

func (*BackendPolicySpec_LoadBalancing_ConsistentHash_) isBackendPolicySpec_LoadBalancing_Algorithm() {
}
...
// Consistently hash requests to endpoints based on a request property,
// providing best-effort session affinity. Ring hash (ketama-style, xxhash64).
type BackendPolicySpec_LoadBalancing_ConsistentHash struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// CEL expression evaluated against the request; its result is the hash
	// key. Requests where evaluation fails or returns null fall back to the
	// default load balancing algorithm. For example
	// `request.headers["x-session-id"]` or `source.address`.
	Key           string `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *BackendPolicySpec_LoadBalancing_ConsistentHash) Reset() {
	*x = BackendPolicySpec_LoadBalancing_ConsistentHash{}
	mi := &file_resource_proto_msgTypes[175]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BackendPolicySpec_LoadBalancing_ConsistentHash) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BackendPolicySpec_LoadBalancing_ConsistentHash) ProtoMessage() {}

func (x *BackendPolicySpec_LoadBalancing_ConsistentHash) ProtoReflect() protoreflect.Message {
	mi := &file_resource_proto_msgTypes[175]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BackendPolicySpec_LoadBalancing_ConsistentHash.ProtoReflect.Descriptor instead.
func (*BackendPolicySpec_LoadBalancing_ConsistentHash) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{56, 12, 0}
}

func (x *BackendPolicySpec_LoadBalancing_ConsistentHash) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
const file_resource_proto_rawDesc = "" +
	...
	"\x0emcp_guardrails\x18\x12 \x01(\v2:.agentgateway.dev.resource.BackendPolicySpec.McpGuardrailsH\x00R\rmcpGuardrails\x12c\n" +
	"\x0eload_balancing\x18\x13 \x01(\v2:.agentgateway.dev.resource.BackendPolicySpec.LoadBalancingH\x00R\rloadBalancing\x1a\xc1,\n" +
	"\x02Ai\x12^\n" +
	...
	"\vFailureMode\x12\b\n" +
	"\x04DENY\x10\x00\x12\t\n" +
	"\x05ALLOW\x10\x01J\x04\b\x01\x10\x02J\x04\b\x02\x10\x03R\x06remoteR\amethods\x1a\xb6\x01\n" +
	"\rLoadBalancing\x12t\n" +
	"\x0fconsistent_hash\x18\x01 \x01(\v2I.agentgateway.dev.resource.BackendPolicySpec.LoadBalancing.ConsistentHashH\x00R\x0econsistentHash\x1a\"\n" +
	"\x0eConsistentHash\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03keyB\v\n" +
	"\talgorithmB\x06\n" +
	"\x04kind\"T\n" +
...
var file_resource_proto_msgTypes = make([]protoimpl.MessageInfo, 205)
var file_resource_proto_goTypes = []any{
	...
	(*Gcp)(nil),                                                 // 77: agentgateway.dev.resource.Gcp
	(*Aws)(nil),                                                 // 78: agentgateway.dev.resource.Aws
	(*Azure)(nil),                                               // 79: agentgateway.dev.resource.Azure
	(*AwsExplicitConfig)(nil),                                   // 80: agentgateway.dev.resource.AwsExplicitConfig
	(*AwsImplicit)(nil),                                         // 81: agentgateway.dev.resource.AwsImplicit
	(*AwsAssumeRole)(nil),                                       // 82: agentgateway.dev.resource.AwsAssumeRole
	(*AwsSessionTag)(nil),                                       // 83: agentgateway.dev.resource.AwsSessionTag
	(*AzureExplicitConfig)(nil),                                 // 84: agentgateway.dev.resource.AzureExplicitConfig
	(*AzureClientSecret)(nil),                                   // 85: agentgateway.dev.resource.AzureClientSecret
	(*AzureManagedIdentityCredential)(nil),                      // 86: agentgateway.dev.resource.AzureManagedIdentityCredential
	(*AzureWorkloadIdentityCredential)(nil),                     // 87: agentgateway.dev.resource.AzureWorkloadIdentityCredential
	(*AzureDeveloperImplicit)(nil),                              // 88: agentgateway.dev.resource.AzureDeveloperImplicit
	(*AzureImplicit)(nil),                                       // 89: agentgateway.dev.resource.AzureImplicit
	(*RouteMatch)(nil),                                          // 90: agentgateway.dev.resource.RouteMatch
	(*PathMatch)(nil),                                           // 91: agentgateway.dev.resource.PathMatch
	(*QueryMatch)(nil),                                          // 92: agentgateway.dev.resource.QueryMatch
	(*MethodMatch)(nil),                                         // 93: agentgateway.dev.resource.MethodMatch
	(*HeaderMatch)(nil),                                         // 94: agentgateway.dev.resource.HeaderMatch
	(*CORS)(nil),                                                // 95: agentgateway.dev.resource.CORS
	(*DirectResponse)(nil),                                      // 96: agentgateway.dev.resource.DirectResponse
	(*ExpressionHeader)(nil),                                    // 97: agentgateway.dev.resource.ExpressionHeader
	(*HeaderModifier)(nil),                                      // 98: agentgateway.dev.resource.HeaderModifier
	(*RequestMirrors)(nil),                                      // 99: agentgateway.dev.resource.RequestMirrors
	(*RequestRedirect)(nil),                                     // 100: agentgateway.dev.resource.RequestRedirect
	(*UrlRewrite)(nil),                                          // 101: agentgateway.dev.resource.UrlRewrite
	(*Header)(nil),                                              // 102: agentgateway.dev.resource.Header
	(*RouteBackend)(nil),                                        // 103: agentgateway.dev.resource.RouteBackend
	(*PolicyTarget)(nil),                                        // 104: agentgateway.dev.resource.PolicyTarget
	(*KeepaliveConfig)(nil),                                     // 105: agentgateway.dev.resource.KeepaliveConfig
	(*FrontendPolicySpec)(nil),                                  // 106: agentgateway.dev.resource.FrontendPolicySpec
	(*JWTValidationOptions)(nil),                                // 107: agentgateway.dev.resource.JWTValidationOptions
	(*TrafficPolicySpec)(nil),                                   // 108: agentgateway.dev.resource.TrafficPolicySpec
	(*BackendPolicySpec)(nil),                                   // 109: agentgateway.dev.resource.BackendPolicySpec
	(*StaticBackend)(nil),                                       // 110: agentgateway.dev.resource.StaticBackend
	(*DynamicForwardProxy)(nil),                                 // 111: agentgateway.dev.resource.DynamicForwardProxy
	(*AwsBackend)(nil),                                          // 112: agentgateway.dev.resource.AwsBackend
	(*AwsAgentCoreBackend)(nil),                                 // 113: agentgateway.dev.resource.AwsAgentCoreBackend
	(*AIBackend)(nil),                                           // 114: agentgateway.dev.resource.AIBackend
	(*MCPBackend)(nil),                                          // 115: agentgateway.dev.resource.MCPBackend
	(*MCPTarget)(nil),                                           // 116: agentgateway.dev.resource.MCPTarget
	(*BackendReference)(nil),                                    // 117: agentgateway.dev.resource.BackendReference
	(*Alpn)(nil),                                                // 118: agentgateway.dev.resource.Alpn
	(*OAuthClientAuth)(nil),                                     // 119: agentgateway.dev.resource.OAuthClientAuth
	(*OAuthTokenExchange)(nil),                                  // 120: agentgateway.dev.resource.OAuthTokenExchange
	(*CrossAppAccessAuth)(nil),                                  // 121: agentgateway.dev.resource.CrossAppAccessAuth
	(*ModelRoute)(nil),                                          // 122: agentgateway.dev.resource.ModelRoute
	(*GuardrailBackend_Bedrock)(nil),                            // 123: agentgateway.dev.resource.GuardrailBackend.Bedrock
	(*GuardrailBackend_GoogleModelArmor)(nil),                   // 124: agentgateway.dev.resource.GuardrailBackend.GoogleModelArmor
	(*GuardrailBackend_AzureContentSafety)(nil),                 // 125: agentgateway.dev.resource.GuardrailBackend.AzureContentSafety
	(*GuardrailBackend_OpenAIModeration)(nil),                   // 126: agentgateway.dev.resource.GuardrailBackend.OpenAIModeration
	(*AuthorizationLocation_Header)(nil),                        // 127: agentgateway.dev.resource.AuthorizationLocation.Header
	(*AuthorizationLocation_QueryParameter)(nil),                // 128: agentgateway.dev.resource.AuthorizationLocation.QueryParameter
	(*AuthorizationLocation_Cookie)(nil),                        // 129: agentgateway.dev.resource.AuthorizationLocation.Cookie
	(*Gcp_AccessToken)(nil),                                     // 130: agentgateway.dev.resource.Gcp.AccessToken
	(*Gcp_IdToken)(nil),                                         // 131: agentgateway.dev.resource.Gcp.IdToken
	(*AzureManagedIdentityCredential_UserAssignedIdentity)(nil), // 132: agentgateway.dev.resource.AzureManagedIdentityCredential.UserAssignedIdentity
	(*RequestMirrors_Mirror)(nil),                               // 133: agentgateway.dev.resource.RequestMirrors.Mirror
	(*PolicyTarget_ServiceTarget)(nil),                          // 134: agentgateway.dev.resource.PolicyTarget.ServiceTarget
	(*PolicyTarget_BackendTarget)(nil),                          // 135: agentgateway.dev.resource.PolicyTarget.BackendTarget
	(*PolicyTarget_GatewayTarget)(nil),                          // 136: agentgateway.dev.resource.PolicyTarget.GatewayTarget
	(*PolicyTarget_RouteTarget)(nil),                            // 137: agentgateway.dev.resource.PolicyTarget.RouteTarget
	(*PolicyTarget_ListenerSetTarget)(nil),                      // 138: agentgateway.dev.resource.PolicyTarget.ListenerSetTarget
	(*FrontendPolicySpec_HTTP)(nil),                             // 139: agentgateway.dev.resource.FrontendPolicySpec.HTTP
	(*FrontendPolicySpec_TLS)(nil),                              // 140: agentgateway.dev.resource.FrontendPolicySpec.TLS
	(*FrontendPolicySpec_TCP)(nil),                              // 141: agentgateway.dev.resource.FrontendPolicySpec.TCP
	(*FrontendPolicySpec_NetworkAuthorization)(nil),             // 142: agentgateway.dev.resource.FrontendPolicySpec.NetworkAuthorization
	(*FrontendPolicySpec_Logging)(nil),                          // 143: agentgateway.dev.resource.FrontendPolicySpec.Logging
	(*FrontendPolicySpec_Tracing)(nil),                          // 144: agentgateway.dev.resource.FrontendPolicySpec.Tracing
	(*FrontendPolicySpec_TracingAttribute)(nil),                 // 145: agentgateway.dev.resource.FrontendPolicySpec.TracingAttribute
	(*FrontendPolicySpec_ProxyProtocol)(nil),                    // 146: agentgateway.dev.resource.FrontendPolicySpec.ProxyProtocol
	(*FrontendPolicySpec_Connect)(nil),                          // 147: agentgateway.dev.resource.FrontendPolicySpec.Connect
	(*FrontendPolicySpec_Metrics)(nil),                          // 148: agentgateway.dev.resource.FrontendPolicySpec.Metrics
	(*FrontendPolicySpec_Logging_Field)(nil),                    // 149: agentgateway.dev.resource.FrontendPolicySpec.Logging.Field
	(*FrontendPolicySpec_Logging_Fields)(nil),                   // 150: agentgateway.dev.resource.FrontendPolicySpec.Logging.Fields
	(*FrontendPolicySpec_Logging_OtlpAccessLog)(nil),            // 151: agentgateway.dev.resource.FrontendPolicySpec.Logging.OtlpAccessLog
	(*FrontendPolicySpec_Metrics_Field)(nil),                    // 152: agentgateway.dev.resource.FrontendPolicySpec.Metrics.Field
	(*FrontendPolicySpec_Metrics_Fields)(nil),                   // 153: agentgateway.dev.resource.FrontendPolicySpec.Metrics.Fields
	(*TrafficPolicySpec_RemoteRateLimit)(nil),                   // 154: agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit
	(*TrafficPolicySpec_LocalRateLimit)(nil),                    // 155: agentgateway.dev.resource.TrafficPolicySpec.LocalRateLimit
	(*TrafficPolicySpec_ExternalAuth)(nil),                      // 156: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth
	(*TrafficPolicySpec_RBAC)(nil),                              // 157: agentgateway.dev.resource.TrafficPolicySpec.RBAC
	(*TrafficPolicySpec_JWTProvider)(nil),                       // 158: agentgateway.dev.resource.TrafficPolicySpec.JWTProvider
	(*TrafficPolicySpec_JWT)(nil),                               // 159: agentgateway.dev.resource.TrafficPolicySpec.JWT
	(*TrafficPolicySpec_BasicAuthentication)(nil),               // 160: agentgateway.dev.resource.TrafficPolicySpec.BasicAuthentication
	(*TrafficPolicySpec_APIKey)(nil),                            // 161: agentgateway.dev.resource.TrafficPolicySpec.APIKey
	(*TrafficPolicySpec_TransformationPolicy)(nil),              // 162: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy
	(*TrafficPolicySpec_HeaderTransformation)(nil),              // 163: agentgateway.dev.resource.TrafficPolicySpec.HeaderTransformation
	(*TrafficPolicySpec_BodyTransformation)(nil),                // 164: agentgateway.dev.resource.TrafficPolicySpec.BodyTransformation
	(*TrafficPolicySpec_CSRF)(nil),                              // 165: agentgateway.dev.resource.TrafficPolicySpec.CSRF
	(*TrafficPolicySpec_ExtProc)(nil),                           // 166: agentgateway.dev.resource.TrafficPolicySpec.ExtProc
	(*TrafficPolicySpec_HostRewrite)(nil),                       // 167: agentgateway.dev.resource.TrafficPolicySpec.HostRewrite
	(*TrafficPolicySpec_Buffer)(nil),                            // 168: agentgateway.dev.resource.TrafficPolicySpec.Buffer
	...
	(*BackendPolicySpec_Ai)(nil),                    // 190: agentgateway.dev.resource.BackendPolicySpec.Ai
	(*BackendPolicySpec_A2A)(nil),                   // 191: agentgateway.dev.resource.BackendPolicySpec.A2a
	(*BackendPolicySpec_InferenceRouting)(nil),      // 192: agentgateway.dev.resource.BackendPolicySpec.InferenceRouting
	(*BackendPolicySpec_Eviction)(nil),              // 193: agentgateway.dev.resource.BackendPolicySpec.Eviction
	(*BackendPolicySpec_Health)(nil),                // 194: agentgateway.dev.resource.BackendPolicySpec.Health
	(*BackendPolicySpec_BackendTLS)(nil),            // 195: agentgateway.dev.resource.BackendPolicySpec.BackendTLS
	(*BackendPolicySpec_BackendHTTP)(nil),           // 196: agentgateway.dev.resource.BackendPolicySpec.BackendHTTP
	(*BackendPolicySpec_BackendTunnel)(nil),         // 197: agentgateway.dev.resource.BackendPolicySpec.BackendTunnel
	(*BackendPolicySpec_BackendTCP)(nil),            // 198: agentgateway.dev.resource.BackendPolicySpec.BackendTCP
	(*BackendPolicySpec_McpAuthorization)(nil),      // 199: agentgateway.dev.resource.BackendPolicySpec.McpAuthorization
	(*BackendPolicySpec_McpAuthentication)(nil),     // 200: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication
	(*BackendPolicySpec_McpGuardrails)(nil),         // 201: agentgateway.dev.resource.BackendPolicySpec.McpGuardrails
	(*BackendPolicySpec_LoadBalancing)(nil),         // 202: agentgateway.dev.resource.BackendPolicySpec.LoadBalancing
	(*BackendPolicySpec_Ai_Message)(nil),            // 203: agentgateway.dev.resource.BackendPolicySpec.Ai.Message
	(*BackendPolicySpec_Ai_PromptEnrichment)(nil),   // 204: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptEnrichment
	(*BackendPolicySpec_Ai_RegexRule)(nil),          // 205: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRule
	(*BackendPolicySpec_Ai_RegexRules)(nil),         // 206: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules
	(*BackendPolicySpec_Ai_Webhook)(nil),            // 207: agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook
	(*BackendPolicySpec_Ai_Moderation)(nil),         // 208: agentgateway.dev.resource.BackendPolicySpec.Ai.Moderation
	(*BackendPolicySpec_Ai_BedrockGuardrails)(nil),  // 209: agentgateway.dev.resource.BackendPolicySpec.Ai.BedrockGuardrails
	(*BackendPolicySpec_Ai_GoogleModelArmor)(nil),   // 210: agentgateway.dev.resource.BackendPolicySpec.Ai.GoogleModelArmor
	(*BackendPolicySpec_Ai_AzureContentSafety)(nil), // 211: agentgateway.dev.resource.BackendPolicySpec.Ai.AzureContentSafety
	(*BackendPolicySpec_Ai_RequestRejection)(nil),   // 212: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestRejection
	(*BackendPolicySpec_Ai_ResponseGuard)(nil),      // 213: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard
	(*BackendPolicySpec_Ai_RequestGuard)(nil),       // 214: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard
	(*BackendPolicySpec_Ai_PromptGuard)(nil),        // 215: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptGuard
	(*BackendPolicySpec_Ai_PromptCaching)(nil),      // 216: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptCaching
	nil, // 217: agentgateway.dev.resource.BackendPolicySpec.Ai.DefaultsEntry
	nil, // 218: agentgateway.dev.resource.BackendPolicySpec.Ai.OverridesEntry
	nil, // 219: agentgateway.dev.resource.BackendPolicySpec.Ai.TransformationsEntry
	nil, // 220: agentgateway.dev.resource.BackendPolicySpec.Ai.ModelAliasesEntry
	nil, // 221: agentgateway.dev.resource.BackendPolicySpec.Ai.RoutesEntry
	(*BackendPolicySpec_McpAuthentication_ResourceMetadata)(nil), // 222: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.ResourceMetadata
	nil, // 223: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.ResourceMetadata.ExtraEntry
	(*BackendPolicySpec_McpGuardrails_Remote)(nil),    // 224: agentgateway.dev.resource.BackendPolicySpec.McpGuardrails.Remote
	(*BackendPolicySpec_McpGuardrails_Processor)(nil), // 225: agentgateway.dev.resource.BackendPolicySpec.McpGuardrails.Processor
	nil, // 226: agentgateway.dev.resource.BackendPolicySpec.McpGuardrails.Remote.MetadataEntry
	nil, // 227: agentgateway.dev.resource.BackendPolicySpec.McpGuardrails.Processor.MethodsEntry
	(*BackendPolicySpec_LoadBalancing_ConsistentHash)(nil), // 228: agentgateway.dev.resource.BackendPolicySpec.LoadBalancing.ConsistentHash
...
var file_resource_proto_depIdxs = []int32{
	...
	122, // 9: agentgateway.dev.resource.Resource.model_route:type_name -> agentgateway.dev.resource.ModelRoute
	...
	90,  // 19: agentgateway.dev.resource.Route.matches:type_name -> agentgateway.dev.resource.RouteMatch
	103, // 20: agentgateway.dev.resource.Route.backends:type_name -> agentgateway.dev.resource.RouteBackend
	108, // 21: agentgateway.dev.resource.Route.traffic_policies:type_name -> agentgateway.dev.resource.TrafficPolicySpec
	...
	103, // 24: agentgateway.dev.resource.TCPRoute.backends:type_name -> agentgateway.dev.resource.RouteBackend
	64,  // 25: agentgateway.dev.resource.ConditionalPolicies.policies:type_name -> agentgateway.dev.resource.ConditionalPolicy
	108, // 26: agentgateway.dev.resource.ConditionalPolicy.traffic:type_name -> agentgateway.dev.resource.TrafficPolicySpec
	58,  // 27: agentgateway.dev.resource.Policy.name:type_name -> agentgateway.dev.resource.TypedResourceName
	104, // 28: agentgateway.dev.resource.Policy.target:type_name -> agentgateway.dev.resource.PolicyTarget
	4,   // 29: agentgateway.dev.resource.Policy.inheritance:type_name -> agentgateway.dev.resource.Policy.Inheritance
	108, // 30: agentgateway.dev.resource.Policy.traffic:type_name -> agentgateway.dev.resource.TrafficPolicySpec
	109, // 31: agentgateway.dev.resource.Policy.backend:type_name -> agentgateway.dev.resource.BackendPolicySpec
	106, // 32: agentgateway.dev.resource.Policy.frontend:type_name -> agentgateway.dev.resource.FrontendPolicySpec
	...
	110, // 35: agentgateway.dev.resource.Backend.static:type_name -> agentgateway.dev.resource.StaticBackend
	114, // 36: agentgateway.dev.resource.Backend.ai:type_name -> agentgateway.dev.resource.AIBackend
	115, // 37: agentgateway.dev.resource.Backend.mcp:type_name -> agentgateway.dev.resource.MCPBackend
	111, // 38: agentgateway.dev.resource.Backend.dynamic:type_name -> agentgateway.dev.resource.DynamicForwardProxy
	112, // 39: agentgateway.dev.resource.Backend.aws:type_name -> agentgateway.dev.resource.AwsBackend
	67,  // 40: agentgateway.dev.resource.Backend.guardrail:type_name -> agentgateway.dev.resource.GuardrailBackend
	109, // 41: agentgateway.dev.resource.Backend.inline_policies:type_name -> agentgateway.dev.resource.BackendPolicySpec
	123, // 42: agentgateway.dev.resource.GuardrailBackend.bedrock:type_name -> agentgateway.dev.resource.GuardrailBackend.Bedrock
	124, // 43: agentgateway.dev.resource.GuardrailBackend.google_model_armor:type_name -> agentgateway.dev.resource.GuardrailBackend.GoogleModelArmor
	125, // 44: agentgateway.dev.resource.GuardrailBackend.azure_content_safety:type_name -> agentgateway.dev.resource.GuardrailBackend.AzureContentSafety
	126, // 45: agentgateway.dev.resource.GuardrailBackend.openai_moderation:type_name -> agentgateway.dev.resource.GuardrailBackend.OpenAIModeration
	...
	77,  // 57: agentgateway.dev.resource.BackendAuthPolicy.gcp:type_name -> agentgateway.dev.resource.Gcp
	78,  // 58: agentgateway.dev.resource.BackendAuthPolicy.aws:type_name -> agentgateway.dev.resource.Aws
	79,  // 59: agentgateway.dev.resource.BackendAuthPolicy.azure:type_name -> agentgateway.dev.resource.Azure
	120, // 60: agentgateway.dev.resource.BackendAuthPolicy.oauth_token_exchange:type_name -> agentgateway.dev.resource.OAuthTokenExchange
	121, // 61: agentgateway.dev.resource.BackendAuthPolicy.cross_app_access:type_name -> agentgateway.dev.resource.CrossAppAccessAuth
	73,  // 62: agentgateway.dev.resource.BackendAuthPolicy.credentials:type_name -> agentgateway.dev.resource.BackendAuthCredential
	74,  // 63: agentgateway.dev.resource.BackendAuthCredential.location:type_name -> agentgateway.dev.resource.AuthorizationLocation
	127, // 64: agentgateway.dev.resource.AuthorizationLocation.header:type_name -> agentgateway.dev.resource.AuthorizationLocation.Header
	128, // 65: agentgateway.dev.resource.AuthorizationLocation.query_parameter:type_name -> agentgateway.dev.resource.AuthorizationLocation.QueryParameter
	129, // 66: agentgateway.dev.resource.AuthorizationLocation.cookie:type_name -> agentgateway.dev.resource.AuthorizationLocation.Cookie
	74,  // 67: agentgateway.dev.resource.Passthrough.authorization_location:type_name -> agentgateway.dev.resource.AuthorizationLocation
	74,  // 68: agentgateway.dev.resource.Key.authorization_location:type_name -> agentgateway.dev.resource.AuthorizationLocation
	130, // 69: agentgateway.dev.resource.Gcp.access_token:type_name -> agentgateway.dev.resource.Gcp.AccessToken
	131, // 70: agentgateway.dev.resource.Gcp.id_token:type_name -> agentgateway.dev.resource.Gcp.IdToken
	80,  // 71: agentgateway.dev.resource.Aws.explicit_config:type_name -> agentgateway.dev.resource.AwsExplicitConfig
	81,  // 72: agentgateway.dev.resource.Aws.implicit:type_name -> agentgateway.dev.resource.AwsImplicit
	82,  // 73: agentgateway.dev.resource.Aws.assume_role:type_name -> agentgateway.dev.resource.AwsAssumeRole
	84,  // 74: agentgateway.dev.resource.Azure.explicit_config:type_name -> agentgateway.dev.resource.AzureExplicitConfig
	88,  // 75: agentgateway.dev.resource.Azure.developer_implicit:type_name -> agentgateway.dev.resource.AzureDeveloperImplicit
	89,  // 76: agentgateway.dev.resource.Azure.implicit:type_name -> agentgateway.dev.resource.AzureImplicit
	83,  // 77: agentgateway.dev.resource.AwsAssumeRole.tags:type_name -> agentgateway.dev.resource.AwsSessionTag
	85,  // 78: agentgateway.dev.resource.AzureExplicitConfig.client_secret:type_name -> agentgateway.dev.resource.AzureClientSecret
	86,  // 79: agentgateway.dev.resource.AzureExplicitConfig.managed_identity_credential:type_name -> agentgateway.dev.resource.AzureManagedIdentityCredential
	87,  // 80: agentgateway.dev.resource.AzureExplicitConfig.workload_identity_credential:type_name -> agentgateway.dev.resource.AzureWorkloadIdentityCredential
	132, // 81: agentgateway.dev.resource.AzureManagedIdentityCredential.user_assigned_identity:type_name -> agentgateway.dev.resource.AzureManagedIdentityCredential.UserAssignedIdentity
	91,  // 82: agentgateway.dev.resource.RouteMatch.path:type_name -> agentgateway.dev.resource.PathMatch
	94,  // 83: agentgateway.dev.resource.RouteMatch.headers:type_name -> agentgateway.dev.resource.HeaderMatch
	93,  // 84: agentgateway.dev.resource.RouteMatch.method:type_name -> agentgateway.dev.resource.MethodMatch
	92,  // 85: agentgateway.dev.resource.RouteMatch.query_params:type_name -> agentgateway.dev.resource.QueryMatch
	261, // 86: agentgateway.dev.resource.CORS.max_age:type_name -> google.protobuf.Duration
	97,  // 87: agentgateway.dev.resource.DirectResponse.headers:type_name -> agentgateway.dev.resource.ExpressionHeader
	102, // 88: agentgateway.dev.resource.HeaderModifier.add:type_name -> agentgateway.dev.resource.Header
	102, // 89: agentgateway.dev.resource.HeaderModifier.set:type_name -> agentgateway.dev.resource.Header
	133, // 90: agentgateway.dev.resource.RequestMirrors.mirrors:type_name -> agentgateway.dev.resource.RequestMirrors.Mirror
	117, // 91: agentgateway.dev.resource.RouteBackend.backend:type_name -> agentgateway.dev.resource.BackendReference
	109, // 92: agentgateway.dev.resource.RouteBackend.backend_policies:type_name -> agentgateway.dev.resource.BackendPolicySpec
	136, // 93: agentgateway.dev.resource.PolicyTarget.gateway:type_name -> agentgateway.dev.resource.PolicyTarget.GatewayTarget
	137, // 94: agentgateway.dev.resource.PolicyTarget.route:type_name -> agentgateway.dev.resource.PolicyTarget.RouteTarget
	135, // 95: agentgateway.dev.resource.PolicyTarget.backend:type_name -> agentgateway.dev.resource.PolicyTarget.BackendTarget
	134, // 96: agentgateway.dev.resource.PolicyTarget.service:type_name -> agentgateway.dev.resource.PolicyTarget.ServiceTarget
	138, // 97: agentgateway.dev.resource.PolicyTarget.listener_set:type_name -> agentgateway.dev.resource.PolicyTarget.ListenerSetTarget
	...
	141, // 100: agentgateway.dev.resource.FrontendPolicySpec.tcp:type_name -> agentgateway.dev.resource.FrontendPolicySpec.TCP
	140, // 101: agentgateway.dev.resource.FrontendPolicySpec.tls:type_name -> agentgateway.dev.resource.FrontendPolicySpec.TLS
	139, // 102: agentgateway.dev.resource.FrontendPolicySpec.http:type_name -> agentgateway.dev.resource.FrontendPolicySpec.HTTP
	143, // 103: agentgateway.dev.resource.FrontendPolicySpec.logging:type_name -> agentgateway.dev.resource.FrontendPolicySpec.Logging
	144, // 104: agentgateway.dev.resource.FrontendPolicySpec.tracing:type_name -> agentgateway.dev.resource.FrontendPolicySpec.Tracing
	142, // 105: agentgateway.dev.resource.FrontendPolicySpec.network_authorization:type_name -> agentgateway.dev.resource.FrontendPolicySpec.NetworkAuthorization
	146, // 106: agentgateway.dev.resource.FrontendPolicySpec.proxy_protocol:type_name -> agentgateway.dev.resource.FrontendPolicySpec.ProxyProtocol
	148, // 107: agentgateway.dev.resource.FrontendPolicySpec.metrics:type_name -> agentgateway.dev.resource.FrontendPolicySpec.Metrics
	147, // 108: agentgateway.dev.resource.FrontendPolicySpec.connect:type_name -> agentgateway.dev.resource.FrontendPolicySpec.Connect
	...
	69,  // 110: agentgateway.dev.resource.TrafficPolicySpec.timeout:type_name -> agentgateway.dev.resource.Timeout
	70,  // 111: agentgateway.dev.resource.TrafficPolicySpec.retry:type_name -> agentgateway.dev.resource.Retry
	155, // 112: agentgateway.dev.resource.TrafficPolicySpec.local_rate_limit:type_name -> agentgateway.dev.resource.TrafficPolicySpec.LocalRateLimit
	156, // 113: agentgateway.dev.resource.TrafficPolicySpec.ext_authz:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth
	157, // 114: agentgateway.dev.resource.TrafficPolicySpec.authorization:type_name -> agentgateway.dev.resource.TrafficPolicySpec.RBAC
	159, // 115: agentgateway.dev.resource.TrafficPolicySpec.jwt:type_name -> agentgateway.dev.resource.TrafficPolicySpec.JWT
	162, // 116: agentgateway.dev.resource.TrafficPolicySpec.transformation:type_name -> agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy
	154, // 117: agentgateway.dev.resource.TrafficPolicySpec.remote_rate_limit:type_name -> agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit
	165, // 118: agentgateway.dev.resource.TrafficPolicySpec.csrf:type_name -> agentgateway.dev.resource.TrafficPolicySpec.CSRF
	166, // 119: agentgateway.dev.resource.TrafficPolicySpec.ext_proc:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc
	98,  // 120: agentgateway.dev.resource.TrafficPolicySpec.request_header_modifier:type_name -> agentgateway.dev.resource.HeaderModifier
	98,  // 121: agentgateway.dev.resource.TrafficPolicySpec.response_header_modifier:type_name -> agentgateway.dev.resource.HeaderModifier
	100, // 122: agentgateway.dev.resource.TrafficPolicySpec.request_redirect:type_name -> agentgateway.dev.resource.RequestRedirect
	101, // 123: agentgateway.dev.resource.TrafficPolicySpec.url_rewrite:type_name -> agentgateway.dev.resource.UrlRewrite
	99,  // 124: agentgateway.dev.resource.TrafficPolicySpec.request_mirror:type_name -> agentgateway.dev.resource.RequestMirrors
	96,  // 125: agentgateway.dev.resource.TrafficPolicySpec.direct_response:type_name -> agentgateway.dev.resource.DirectResponse
	95,  // 126: agentgateway.dev.resource.TrafficPolicySpec.cors:type_name -> agentgateway.dev.resource.CORS
	160, // 127: agentgateway.dev.resource.TrafficPolicySpec.basic_auth:type_name -> agentgateway.dev.resource.TrafficPolicySpec.BasicAuthentication
	161, // 128: agentgateway.dev.resource.TrafficPolicySpec.api_key_auth:type_name -> agentgateway.dev.resource.TrafficPolicySpec.APIKey
	167, // 129: agentgateway.dev.resource.TrafficPolicySpec.host_rewrite:type_name -> agentgateway.dev.resource.TrafficPolicySpec.HostRewrite
	168, // 130: agentgateway.dev.resource.TrafficPolicySpec.buffer:type_name -> agentgateway.dev.resource.TrafficPolicySpec.Buffer
	71,  // 131: agentgateway.dev.resource.TrafficPolicySpec.delay:type_name -> agentgateway.dev.resource.Delay
	191, // 132: agentgateway.dev.resource.BackendPolicySpec.a2a:type_name -> agentgateway.dev.resource.BackendPolicySpec.A2a
	192, // 133: agentgateway.dev.resource.BackendPolicySpec.inference_routing:type_name -> agentgateway.dev.resource.BackendPolicySpec.InferenceRouting
	195, // 134: agentgateway.dev.resource.BackendPolicySpec.backend_tls:type_name -> agentgateway.dev.resource.BackendPolicySpec.BackendTLS
	72,  // 135: agentgateway.dev.resource.BackendPolicySpec.auth:type_name -> agentgateway.dev.resource.BackendAuthPolicy
	199, // 136: agentgateway.dev.resource.BackendPolicySpec.mcp_authorization:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthorization
	200, // 137: agentgateway.dev.resource.BackendPolicySpec.mcp_authentication:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthentication
	190, // 138: agentgateway.dev.resource.BackendPolicySpec.ai:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai
	98,  // 139: agentgateway.dev.resource.BackendPolicySpec.request_header_modifier:type_name -> agentgateway.dev.resource.HeaderModifier
	98,  // 140: agentgateway.dev.resource.BackendPolicySpec.response_header_modifier:type_name -> agentgateway.dev.resource.HeaderModifier
	100, // 141: agentgateway.dev.resource.BackendPolicySpec.request_redirect:type_name -> agentgateway.dev.resource.RequestRedirect
	99,  // 142: agentgateway.dev.resource.BackendPolicySpec.request_mirror:type_name -> agentgateway.dev.resource.RequestMirrors
	196, // 143: agentgateway.dev.resource.BackendPolicySpec.backend_http:type_name -> agentgateway.dev.resource.BackendPolicySpec.BackendHTTP
	198, // 144: agentgateway.dev.resource.BackendPolicySpec.backend_tcp:type_name -> agentgateway.dev.resource.BackendPolicySpec.BackendTCP
	162, // 145: agentgateway.dev.resource.BackendPolicySpec.transformation:type_name -> agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy
	194, // 146: agentgateway.dev.resource.BackendPolicySpec.health:type_name -> agentgateway.dev.resource.BackendPolicySpec.Health
	197, // 147: agentgateway.dev.resource.BackendPolicySpec.backend_tunnel:type_name -> agentgateway.dev.resource.BackendPolicySpec.BackendTunnel
	156, // 148: agentgateway.dev.resource.BackendPolicySpec.ext_authz:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth
	201, // 149: agentgateway.dev.resource.BackendPolicySpec.mcp_guardrails:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpGuardrails
	202, // 150: agentgateway.dev.resource.BackendPolicySpec.load_balancing:type_name -> agentgateway.dev.resource.BackendPolicySpec.LoadBalancing
	113, // 151: agentgateway.dev.resource.AwsBackend.agent_core:type_name -> agentgateway.dev.resource.AwsAgentCoreBackend
	240, // 152: agentgateway.dev.resource.AIBackend.provider_groups:type_name -> agentgateway.dev.resource.AIBackend.ProviderGroup
	116, // 153: agentgateway.dev.resource.MCPBackend.targets:type_name -> agentgateway.dev.resource.MCPTarget
	...
	117, // 157: agentgateway.dev.resource.MCPTarget.backend:type_name -> agentgateway.dev.resource.BackendReference
	...
	117, // 162: agentgateway.dev.resource.OAuthTokenExchange.token_endpoint:type_name -> agentgateway.dev.resource.BackendReference
	51,  // 163: agentgateway.dev.resource.OAuthTokenExchange.grant_type:type_name -> agentgateway.dev.resource.OAuthTokenExchange.GrantType
	...
	119, // 167: agentgateway.dev.resource.OAuthTokenExchange.client_auth:type_name -> agentgateway.dev.resource.OAuthClientAuth
	74,  // 168: agentgateway.dev.resource.OAuthTokenExchange.authorization_location:type_name -> agentgateway.dev.resource.AuthorizationLocation
	...
	190, // 177: agentgateway.dev.resource.ModelRoute.ai_policy:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai
	157, // 178: agentgateway.dev.resource.ModelRoute.authorization:type_name -> agentgateway.dev.resource.TrafficPolicySpec.RBAC
	117, // 179: agentgateway.dev.resource.RequestMirrors.Mirror.backend:type_name -> agentgateway.dev.resource.BackendReference
	...
	118, // 186: agentgateway.dev.resource.FrontendPolicySpec.TLS.alpn:type_name -> agentgateway.dev.resource.Alpn
	...
	105, // 191: agentgateway.dev.resource.FrontendPolicySpec.TCP.keepalives:type_name -> agentgateway.dev.resource.KeepaliveConfig
	150, // 192: agentgateway.dev.resource.FrontendPolicySpec.Logging.fields:type_name -> agentgateway.dev.resource.FrontendPolicySpec.Logging.Fields
	151, // 193: agentgateway.dev.resource.FrontendPolicySpec.Logging.otlp_access_log:type_name -> agentgateway.dev.resource.FrontendPolicySpec.Logging.OtlpAccessLog
	117, // 194: agentgateway.dev.resource.FrontendPolicySpec.Tracing.provider_backend:type_name -> agentgateway.dev.resource.BackendReference
	145, // 195: agentgateway.dev.resource.FrontendPolicySpec.Tracing.attributes:type_name -> agentgateway.dev.resource.FrontendPolicySpec.TracingAttribute
	145, // 196: agentgateway.dev.resource.FrontendPolicySpec.Tracing.resources:type_name -> agentgateway.dev.resource.FrontendPolicySpec.TracingAttribute
	...
	153, // 201: agentgateway.dev.resource.FrontendPolicySpec.Metrics.fields:type_name -> agentgateway.dev.resource.FrontendPolicySpec.Metrics.Fields
	149, // 202: agentgateway.dev.resource.FrontendPolicySpec.Logging.Fields.add:type_name -> agentgateway.dev.resource.FrontendPolicySpec.Logging.Field
	117, // 203: agentgateway.dev.resource.FrontendPolicySpec.Logging.OtlpAccessLog.provider_backend:type_name -> agentgateway.dev.resource.BackendReference
	109, // 204: agentgateway.dev.resource.FrontendPolicySpec.Logging.OtlpAccessLog.inline_policies:type_name -> agentgateway.dev.resource.BackendPolicySpec
	...
	150, // 206: agentgateway.dev.resource.FrontendPolicySpec.Logging.OtlpAccessLog.fields:type_name -> agentgateway.dev.resource.FrontendPolicySpec.Logging.Fields
	152, // 207: agentgateway.dev.resource.FrontendPolicySpec.Metrics.Fields.add:type_name -> agentgateway.dev.resource.FrontendPolicySpec.Metrics.Field
	...
	117, // 209: agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.target:type_name -> agentgateway.dev.resource.BackendReference
	...
	117, // 213: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.target:type_name -> agentgateway.dev.resource.BackendReference
	...
	107, // 219: agentgateway.dev.resource.TrafficPolicySpec.JWTProvider.jwt_validation_options:type_name -> agentgateway.dev.resource.JWTValidationOptions
	...
	158, // 221: agentgateway.dev.resource.TrafficPolicySpec.JWT.providers:type_name -> agentgateway.dev.resource.TrafficPolicySpec.JWTProvider
	...
	74,  // 223: agentgateway.dev.resource.TrafficPolicySpec.JWT.authorization_location:type_name -> agentgateway.dev.resource.AuthorizationLocation
	...
	74,  // 225: agentgateway.dev.resource.TrafficPolicySpec.BasicAuthentication.authorization_location:type_name -> agentgateway.dev.resource.AuthorizationLocation
	...
	74,  // 228: agentgateway.dev.resource.TrafficPolicySpec.APIKey.authorization_location:type_name -> agentgateway.dev.resource.AuthorizationLocation
	...
	117, // 231: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.target:type_name -> agentgateway.dev.resource.BackendReference
	...
	170, // 240: agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.Descriptor.entries:type_name -> agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.Entry
	17,  // 241: agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.Descriptor.type:type_name -> agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.Type
	175, // 242: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.GRPCProtocol.context:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.GRPCProtocol.ContextEntry
	176, // 243: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.GRPCProtocol.metadata:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.GRPCProtocol.MetadataEntry
	177, // 244: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.HTTPProtocol.add_request_headers:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.HTTPProtocol.AddRequestHeadersEntry
	178, // 245: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.HTTPProtocol.metadata:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.HTTPProtocol.MetadataEntry
	37,  // 246: agentgateway.dev.resource.TrafficPolicySpec.JWT.MCP.provider:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.McpIDP
	222, // 247: agentgateway.dev.resource.TrafficPolicySpec.JWT.MCP.resource_metadata:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.ResourceMetadata
	262, // 248: agentgateway.dev.resource.TrafficPolicySpec.APIKey.User.metadata:type_name -> google.protobuf.Struct
	163, // 249: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform.set:type_name -> agentgateway.dev.resource.TrafficPolicySpec.HeaderTransformation
	163, // 250: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform.add:type_name -> agentgateway.dev.resource.TrafficPolicySpec.HeaderTransformation
	164, // 251: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform.body:type_name -> agentgateway.dev.resource.TrafficPolicySpec.BodyTransformation
	182, // 252: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform.metadata:type_name -> agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform.MetadataEntry
	188, // 253: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.NamespacedMetadataContext.context:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.NamespacedMetadataContext.ContextEntry
	25,  // 254: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.ProcessingOptions.request_body_mode:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.BodySendMode
	25,  // 255: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.ProcessingOptions.response_body_mode:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.BodySendMode
	26,  // 256: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.ProcessingOptions.request_header_mode:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.HeaderTrailerSendMode
	26,  // 257: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.ProcessingOptions.response_header_mode:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.HeaderTrailerSendMode
	26,  // 258: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.ProcessingOptions.request_trailer_mode:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.HeaderTrailerSendMode
	26,  // 259: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.ProcessingOptions.response_trailer_mode:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.HeaderTrailerSendMode
	185, // 260: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.MetadataContextEntry.value:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.NamespacedMetadataContext
	28,  // 261: agentgateway.dev.resource.TrafficPolicySpec.Buffer.BufferBody.failure_mode:type_name -> agentgateway.dev.resource.TrafficPolicySpec.Buffer.FailureMode
	215, // 262: agentgateway.dev.resource.BackendPolicySpec.Ai.prompt_guard:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.PromptGuard
	217, // 263: agentgateway.dev.resource.BackendPolicySpec.Ai.defaults:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.DefaultsEntry
	218, // 264: agentgateway.dev.resource.BackendPolicySpec.Ai.overrides:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.OverridesEntry
	219, // 265: agentgateway.dev.resource.BackendPolicySpec.Ai.transformations:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.TransformationsEntry
	204, // 266: agentgateway.dev.resource.BackendPolicySpec.Ai.prompts:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.PromptEnrichment
	220, // 267: agentgateway.dev.resource.BackendPolicySpec.Ai.model_aliases:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.ModelAliasesEntry
	216, // 268: agentgateway.dev.resource.BackendPolicySpec.Ai.prompt_caching:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.PromptCaching
	221, // 269: agentgateway.dev.resource.BackendPolicySpec.Ai.routes:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RoutesEntry
	117, // 270: agentgateway.dev.resource.BackendPolicySpec.InferenceRouting.endpoint_picker:type_name -> agentgateway.dev.resource.BackendReference
	34,  // 271: agentgateway.dev.resource.BackendPolicySpec.InferenceRouting.failure_mode:type_name -> agentgateway.dev.resource.BackendPolicySpec.InferenceRouting.FailureMode
	261, // 272: agentgateway.dev.resource.BackendPolicySpec.Eviction.duration:type_name -> google.protobuf.Duration
	193, // 273: agentgateway.dev.resource.BackendPolicySpec.Health.eviction:type_name -> agentgateway.dev.resource.BackendPolicySpec.Eviction
	35,  // 274: agentgateway.dev.resource.BackendPolicySpec.BackendTLS.verification:type_name -> agentgateway.dev.resource.BackendPolicySpec.BackendTLS.VerificationMode
	118, // 275: agentgateway.dev.resource.BackendPolicySpec.BackendTLS.alpn:type_name -> agentgateway.dev.resource.Alpn
	9,   // 276: agentgateway.dev.resource.BackendPolicySpec.BackendTLS.key_exchange_groups:type_name -> agentgateway.dev.resource.TLSConfig.KeyExchangeGroup
	36,  // 277: agentgateway.dev.resource.BackendPolicySpec.BackendHTTP.version:type_name -> agentgateway.dev.resource.BackendPolicySpec.BackendHTTP.HttpVersion
	261, // 278: agentgateway.dev.resource.BackendPolicySpec.BackendHTTP.request_timeout:type_name -> google.protobuf.Duration
	117, // 279: agentgateway.dev.resource.BackendPolicySpec.BackendTunnel.proxy:type_name -> agentgateway.dev.resource.BackendReference
	105, // 280: agentgateway.dev.resource.BackendPolicySpec.BackendTCP.keepalive:type_name -> agentgateway.dev.resource.KeepaliveConfig
	261, // 281: agentgateway.dev.resource.BackendPolicySpec.BackendTCP.connect_timeout:type_name -> google.protobuf.Duration
	37,  // 282: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.provider:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.McpIDP
	222, // 283: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.resource_metadata:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.ResourceMetadata
	38,  // 284: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.mode:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.Mode
	107, // 285: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.jwt_validation_options:type_name -> agentgateway.dev.resource.JWTValidationOptions
	74,  // 286: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.authorization_location:type_name -> agentgateway.dev.resource.AuthorizationLocation
	225, // 287: agentgateway.dev.resource.BackendPolicySpec.McpGuardrails.processors:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpGuardrails.Processor
	228, // 288: agentgateway.dev.resource.BackendPolicySpec.LoadBalancing.consistent_hash:type_name -> agentgateway.dev.resource.BackendPolicySpec.LoadBalancing.ConsistentHash
	203, // 289: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptEnrichment.append:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Message
	203, // 290: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptEnrichment.prepend:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Message
	29,  // 291: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRule.builtin:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.BuiltinRegexRule
	30,  // 292: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules.action:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.ActionKind
	205, // 293: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules.rules:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRule
	117, // 294: agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook.backend:type_name -> agentgateway.dev.resource.BackendReference
	94,  // 295: agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook.forward_header_matches:type_name -> agentgateway.dev.resource.HeaderMatch
	32,  // 296: agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook.failure_mode:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook.FailureMode
	109, // 297: agentgateway.dev.resource.BackendPolicySpec.Ai.Moderation.inline_policies:type_name -> agentgateway.dev.resource.BackendPolicySpec
	117, // 298: agentgateway.dev.resource.BackendPolicySpec.Ai.Moderation.backend_ref:type_name -> agentgateway.dev.resource.BackendReference
	109, // 299: agentgateway.dev.resource.BackendPolicySpec.Ai.BedrockGuardrails.inline_policies:type_name -> agentgateway.dev.resource.BackendPolicySpec
	117, // 300: agentgateway.dev.resource.BackendPolicySpec.Ai.BedrockGuardrails.backend_ref:type_name -> agentgateway.dev.resource.BackendReference
	109, // 301: agentgateway.dev.resource.BackendPolicySpec.Ai.GoogleModelArmor.inline_policies:type_name -> agentgateway.dev.resource.BackendPolicySpec
	117, // 302: agentgateway.dev.resource.BackendPolicySpec.Ai.GoogleModelArmor.backend_ref:type_name -> agentgateway.dev.resource.BackendReference
	109, // 303: agentgateway.dev.resource.BackendPolicySpec.Ai.AzureContentSafety.inline_policies:type_name -> agentgateway.dev.resource.BackendPolicySpec
	117, // 304: agentgateway.dev.resource.BackendPolicySpec.Ai.AzureContentSafety.backend_ref:type_name -> agentgateway.dev.resource.BackendReference
	212, // 305: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.rejection:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RequestRejection
	206, // 306: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.regex:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules
	207, // 307: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.webhook:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook
	210, // 308: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.google_model_armor:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.GoogleModelArmor
	209, // 309: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.bedrock_guardrails:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.BedrockGuardrails
	211, // 310: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.azure_content_safety:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.AzureContentSafety
	212, // 311: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.rejection:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RequestRejection
	206, // 312: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.regex:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules
	207, // 313: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.webhook:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook
	208, // 314: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.openai_moderation:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Moderation
	210, // 315: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.google_model_armor:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.GoogleModelArmor
	209, // 316: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.bedrock_guardrails:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.BedrockGuardrails
	211, // 317: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.azure_content_safety:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.AzureContentSafety
	214, // 318: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptGuard.request:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard
	213, // 319: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptGuard.response:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard
	33,  // 320: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptGuard.streaming:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.PromptGuard.Streaming
	31,  // 321: agentgateway.dev.resource.BackendPolicySpec.Ai.RoutesEntry.value:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RouteType
	223, // 322: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.ResourceMetadata.extra:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.ResourceMetadata.ExtraEntry
	263, // 323: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.ResourceMetadata.ExtraEntry.value:type_name -> google.protobuf.Value
	117, // 324: agentgateway.dev.resource.BackendPolicySpec.McpGuardrails.Remote.target:type_name -> agentgateway.dev.resource.BackendReference
	40,  // 325: agentgateway.dev.resource.BackendPolicySpec.McpGuardrails.Remote.failure_mode:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpGuardrails.FailureMode
	226, // 326: agentgateway.dev.resource.BackendPolicySpec.McpGuardrails.Remote.metadata:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpGuardrails.Remote.MetadataEntry
	224, // 327: agentgateway.dev.resource.BackendPolicySpec.McpGuardrails.Processor.remote:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpGuardrails.Remote
	227, // 328: agentgateway.dev.resource.BackendPolicySpec.McpGuardrails.Processor.methods:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpGuardrails.Processor.MethodsEntry
	39,  // 329: agentgateway.dev.resource.BackendPolicySpec.McpGuardrails.Processor.MethodsEntry.value:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpGuardrails.Phase
	41,  // 330: agentgateway.dev.resource.AIBackend.Azure.resource_type:type_name -> agentgateway.dev.resource.AIBackend.AzureResourceType
	42,  // 331: agentgateway.dev.resource.AIBackend.ProviderFormatConfig.format:type_name -> agentgateway.dev.resource.AIBackend.ProviderFormat
	237, // 332: agentgateway.dev.resource.AIBackend.Custom.formats:type_name -> agentgateway.dev.resource.AIBackend.ProviderFormatConfig
	229, // 333: agentgateway.dev.resource.AIBackend.Provider.host_override:type_name -> agentgateway.dev.resource.AIBackend.HostOverride
	117, // 334: agentgateway.dev.resource.AIBackend.Provider.provider_backend:type_name -> agentgateway.dev.resource.BackendReference
	230, // 335: agentgateway.dev.resource.AIBackend.Provider.openai:type_name -> agentgateway.dev.resource.AIBackend.OpenAI
	231, // 336: agentgateway.dev.resource.AIBackend.Provider.gemini:type_name -> agentgateway.dev.resource.AIBackend.Gemini
	232, // 337: agentgateway.dev.resource.AIBackend.Provider.vertex:type_name -> agentgateway.dev.resource.AIBackend.Vertex
	233, // 338: agentgateway.dev.resource.AIBackend.Provider.anthropic:type_name -> agentgateway.dev.resource.AIBackend.Anthropic
	234, // 339: agentgateway.dev.resource.AIBackend.Provider.bedrock:type_name -> agentgateway.dev.resource.AIBackend.Bedrock
	235, // 340: agentgateway.dev.resource.AIBackend.Provider.azureopenai:type_name -> agentgateway.dev.resource.AIBackend.AzureOpenAI
	236, // 341: agentgateway.dev.resource.AIBackend.Provider.azure:type_name -> agentgateway.dev.resource.AIBackend.Azure
	238, // 342: agentgateway.dev.resource.AIBackend.Provider.custom:type_name -> agentgateway.dev.resource.AIBackend.Custom
	43,  // 343: agentgateway.dev.resource.AIBackend.Provider.provider_preset:type_name -> agentgateway.dev.resource.AIBackend.ProviderPreset
	109, // 344: agentgateway.dev.resource.AIBackend.Provider.inline_policies:type_name -> agentgateway.dev.resource.BackendPolicySpec
	239, // 345: agentgateway.dev.resource.AIBackend.ProviderGroup.providers:type_name -> agentgateway.dev.resource.AIBackend.Provider
	49,  // 346: agentgateway.dev.resource.OAuthClientAuth.PrivateKeyJwt.alg:type_name -> agentgateway.dev.resource.OAuthClientAuth.PrivateKeyJwt.SigningAlg
	50,  // 347: agentgateway.dev.resource.OAuthClientAuth.PrivateKeyJwt.certificate_header:type_name -> agentgateway.dev.resource.OAuthClientAuth.PrivateKeyJwt.CertificateHeader
	74,  // 348: agentgateway.dev.resource.OAuthTokenExchange.TokenSpec.source:type_name -> agentgateway.dev.resource.AuthorizationLocation
	74,  // 349: agentgateway.dev.resource.OAuthTokenExchange.ActorToken.source:type_name -> agentgateway.dev.resource.AuthorizationLocation
	247, // 350: agentgateway.dev.resource.OAuthTokenExchange.TokenCache.in_memory:type_name -> agentgateway.dev.resource.OAuthTokenExchange.TokenCache.InMemory
	261, // 351: agentgateway.dev.resource.OAuthTokenExchange.TokenCache.InMemory.default_ttl:type_name -> google.protobuf.Duration
	117, // 352: agentgateway.dev.resource.CrossAppAccessAuth.Endpoint.token_endpoint:type_name -> agentgateway.dev.resource.BackendReference
	119, // 353: agentgateway.dev.resource.CrossAppAccessAuth.Endpoint.client_auth:type_name -> agentgateway.dev.resource.OAuthClientAuth
	74,  // 354: agentgateway.dev.resource.CrossAppAccessAuth.SubjectToken.source:type_name -> agentgateway.dev.resource.AuthorizationLocation
	253, // 355: agentgateway.dev.resource.ModelRoute.VirtualModel.weighted:type_name -> agentgateway.dev.resource.ModelRoute.VirtualModel.Weighted
	254, // 356: agentgateway.dev.resource.ModelRoute.VirtualModel.conditional:type_name -> agentgateway.dev.resource.ModelRoute.VirtualModel.Conditional
	255, // 357: agentgateway.dev.resource.ModelRoute.VirtualModel.failover:type_name -> agentgateway.dev.resource.ModelRoute.VirtualModel.Failover
	52,  // 358: agentgateway.dev.resource.ModelRoute.ConcreteModel.model_visibility:type_name -> agentgateway.dev.resource.ModelRoute.ConcreteModel.ModelVisibility
	117, // 359: agentgateway.dev.resource.ModelRoute.ConcreteModel.backend:type_name -> agentgateway.dev.resource.BackendReference
	109, // 360: agentgateway.dev.resource.ModelRoute.ConcreteModel.backend_policies:type_name -> agentgateway.dev.resource.BackendPolicySpec
	256, // 361: agentgateway.dev.resource.ModelRoute.VirtualModel.Weighted.targets:type_name -> agentgateway.dev.resource.ModelRoute.VirtualModel.Weighted.Target
	257, // 362: agentgateway.dev.resource.ModelRoute.VirtualModel.Conditional.targets:type_name -> agentgateway.dev.resource.ModelRoute.VirtualModel.Conditional.Target
	117, // 363: agentgateway.dev.resource.ModelRoute.VirtualModel.Failover.backend:type_name -> agentgateway.dev.resource.BackendReference
	364, // [364:364] is the sub-list for method output_type
	364, // [364:364] is the sub-list for method input_type
	364, // [364:364] is the sub-list for extension type_name
	364, // [364:364] is the sub-list for extension extendee
	0,   // [0:364] is the sub-list for field type_name
}
...
func file_resource_proto_init() {
	...
	file_resource_proto_msgTypes[56].OneofWrappers = []any{
		...
		(*BackendPolicySpec_LoadBalancing_)(nil),
	}
	...
	file_resource_proto_msgTypes[149].OneofWrappers = []any{
		(*BackendPolicySpec_LoadBalancing_ConsistentHash_)(nil),
	}
